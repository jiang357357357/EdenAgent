...
const nonRetryable = /request retries exhausted|GoUsageLimitError|FreeUsageLimitError|monthly usage limit|available balance|insufficient_quota|out of budget|quota exceeded|billing|unauthorized|forbidden|invalid api key|context length|context window/i
