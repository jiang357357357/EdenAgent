# MonAgent Hearts of Iron IV Observer Connector

This official connector package contains an isolated Rust Worker and the game-side, read-only HOI4 Mod. The Worker communicates with MonAgent only through Connector Protocol v1; the Server has no HOI4 runtime branch.
