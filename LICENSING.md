...
## Effective date and earlier releases

This licensing model applies to versions first distributed with this notice on or after 2026-08-24. A copy previously received under the MIT License remains licensed under the MIT terms that accompanied that copy. This change does not revoke permissions already granted for an earlier MIT-licensed version.
